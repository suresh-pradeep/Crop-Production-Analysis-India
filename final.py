...
if choose == "About":
    ...
    video_file = open('videos_racin/spices_video.mp4', 'rb')
    video_bytes = video_file.read()
    st.video(video_bytes)
    video_file = open('videos_racin/nuts_seeds_video.mp4', 'rb')
    video_bytes = video_file.read()
    st.video(video_bytes)
    video_file = open('videos_racin/vegetable_fruits_video.mp4', 'rb')
    video_bytes = video_file.read()
    st.video(video_bytes)
